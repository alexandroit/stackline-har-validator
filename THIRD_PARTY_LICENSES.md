...
| --- | --- | --- | --- |
| ajv | 6.15.0 | MIT | `licenses/ajv-6.15.0-MIT.txt` |
| fast-deep-equal | 3.1.3 | MIT | `licenses/fast-deep-equal-3.1.3-MIT.txt` |
| fast-json-stable-stringify | 2.1.0 | MIT | `licenses/fast-json-stable-stringify-2.1.0-MIT.txt` |
| json-schema-traverse | 0.4.1 | MIT | `licenses/json-schema-traverse-0.4.1-MIT.txt` |
| uri-js | 4.4.1 | BSD-2-Clause | `licenses/uri-js-4.4.1-BSD-2-Clause.txt` |
